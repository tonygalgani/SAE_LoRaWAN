...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0xD6, 0x48 }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x2E, 0xCE, 0x79, 0x1A, 0xA5, 0x3E, 0x87, 0xBC, 0xCE, 0xD4, 0x60, 0xAD, 0x98, 0x52, 0x35, 0x03 } // set by application[*]
#define MBED_CONF_LORA_APPSKEY                                                { 0x47, 0x0C, 0xCE, 0x54, 0xDB, 0xD6, 0x35, 0x02, 0x4B, 0x83, 0x73, 0xF2, 0x38, 0x52, 0xBA, 0x76 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_ADDRESS                                          0x260B89AE                                                                                        // set by application[*]
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0xD5, 0xA4 }                                                 // set by application[*]
...
#define MBED_CONF_LORA_NWKSKEY                                                { 0x69, 0x65, 0xA9, 0x25, 0x23, 0xC3, 0x7D, 0x78, 0x9D, 0xBB, 0x93, 0x06, 0xF0, 0xAA, 0x70, 0xCB } // set by application[*]
