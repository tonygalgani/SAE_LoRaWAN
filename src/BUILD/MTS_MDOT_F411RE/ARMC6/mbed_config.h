...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0x16, 0x8E }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x77, 0x8A, 0x26, 0xDF, 0x9D, 0x70, 0xDB, 0xEF, 0x43, 0x03, 0x0F, 0xD2, 0x5F, 0x47, 0x1D, 0x00 } // set by application[*]
#define MBED_CONF_LORA_APPSKEY                                                { 0x34, 0x2F, 0x9F, 0xF4, 0xAC, 0xF7, 0xA2, 0x03, 0x19, 0xAC, 0x02, 0xE8, 0x64, 0xD2, 0xD6, 0xAA } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_ADDRESS                                          0x260BAAAA                                                                                        // set by application[*]
#define MBED_CONF_LORA_DEVICE_EUI                                              {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x05, 0xD3, 0xBF}                                                  // set by application[*]
...
#define MBED_CONF_LORA_NWKSKEY                                                { 0x68, 0xCE, 0x3C, 0x3D, 0x8F, 0xE1, 0xAC, 0x24, 0xEE, 0xCE, 0x65, 0xF3, 0xF5, 0xB8, 0x08, 0xDB}  // set by application[*]
